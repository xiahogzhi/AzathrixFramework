...
using ParaCrossGames.Framework.Events.Core;
...
namespace ParaCrossGames.Framework.Core
{
    public static class PuffinFramework
    {
        ...
        public static void Setup(SetupContext setupContext)
        {
            ...
            ScannerConfig = setupContext.ScannerConfig ?? Perference.Instance.ToScannerConfig();
            RuntimeConfig = setupContext.runtimeConfig ?? Perference.Instance.ToRuntimeConfig();
            IsSetup = true;
        ...
        {
            var settings = Perference.Instance;
